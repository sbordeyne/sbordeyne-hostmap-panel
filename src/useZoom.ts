// Copied from https://github.com/grafana/grafana/blob/8e11851bb085fac6ce2438d4b7dd5d340100ce48/public/app/plugins/panel/nodeGraph/useZoom.ts
...
export function useZoom(options: Options = defaultOptions) {
  ...
  const setScaleAbsolute = useCallback(
    (value: number) => {
